...
const DEFAULT_LINTS: &'static str = "plrust_extern_blocks, plrust_lifetime_parameterized_traits, implied_bounds_entailment, plrust_fn_pointers, plrust_filesystem_macros, plrust_async, unsafe_code";
