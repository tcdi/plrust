...
naersk.lib."${targetPlatform.system}".buildPackage rec {
  ...
  cargoBuildOptions = default: default ++ [ "--no-default-features" "--features \"sandboxed pg${pgxPostgresVersionString}\"" ];
  cargoTestOptions = default: default ++ [ "--no-default-features" "--features \"pg_test sandboxed pg${pgxPostgresVersionString}\"" ];
  copyLibs = true;
